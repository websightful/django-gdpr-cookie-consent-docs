...
```
Django==5.0
file:./private_wheels/django_gdpr_cookie_consent-2.2.1-py2.py3-none-any.whl
```
...
```shell
(venv)$ pip install /path/to/django_gdpr_cookie_consent-2.2.1-py2.py3-none-any.whl
```
